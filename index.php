...
<body id="top">
    ...
    <div class="bloque uno" id="convocatoria" color="#ffff66">
        ...
        <h1 class="titulo">
            <span min-weight="740" max-weight="900">CONVOCATORIA</span>
            <br /> <span min-weight="600" max-weight="900">TRIMARCHI 2021</span><br />
            <span min-weight="600" max-weight="900">17JUN-31JUL</span>
        </h1>
        <p class="destacado">
        <span>
    ...
    <div class="bloque dos" id="categorias" color="#99ff99">
        <h1 class="titulo" min-weight="740" max-weight="900">
            CATEGORÍAS
        </h1>
        <div class="columnas">
            <div class="columna">
...
Si lo tuyo es el diseño gráfico, inscribite en esta categoría, mostranos lo que hacés y tené la posibilidad de:
    ...
    <div class="bloque tres" id="jurado" color="#ffccff" min-weight="740" max-weight="900">
        <h1 class="titulo"  min-weight="740" max-weight="900">
            JURADO
        </h1>
        <div class="columnas">
