...
<form name="register-form" class="register-form">
    ...
    <p class="texto centrado">
        Podés hacerlo <a target="_blank" href="https://www.domestika.org/">acá</a>. Al crear tu perfil, te recomendamos hacerlo de manera completa (agregá una foto de perfil y contanos algo sobre vos). Eso nos ayudará a conocerte más y te dará mayores chances de ser elegido. <br/>
